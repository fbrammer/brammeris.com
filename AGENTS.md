...
Read [CONTROL/Standards/COMM_STANDARD.md](../../CONTROL/Standards/COMM_STANDARD.md) and follow it in every response.
...
- [./2026-06-13-website-modernization-plan.md](2026-06-13-website-modernization-plan.md) — planning note for the current visual refresh

## How to work here
1. Read this file to find the relevant file.
2. Read [./SETUP.md](SETUP.md) before making deployment-related changes.
